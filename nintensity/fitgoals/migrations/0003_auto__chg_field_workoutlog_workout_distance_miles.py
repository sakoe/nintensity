...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkoutLog.workout_distance_miles'
        db.alter_column(u'fitgoals_workoutlog', 'workout_distance_miles', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'WorkoutLog.workout_distance_miles'
        db.alter_column(u'fitgoals_workoutlog', 'workout_distance_miles', self.gf('django.db.models.fields.IntegerField')())
