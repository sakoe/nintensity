...
class UserProfile(models.Model):
    ...
    screen_name = models.CharField(max_length=35, help_text='Supply if you want to go by a name other than your username.')
    MALE = 'M'
    FEMALE = 'F'
    DECLINE_TO_STATE = "X"
    GENDER_CHOICES = (
    ...
    gender = models.CharField(max_length=1, choices=GENDER_CHOICES, default=DECLINE_TO_STATE, 
        help_text='For use in gender-specific leaderboards.')
